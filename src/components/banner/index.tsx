 ...
 return (
   ...
   <PagerView style={{ flex:1}} initialPage={0} pageMargin={14}>
    <Pressable className='w-full h-36 md:h-60 rounded-2xl' key="1" onPress={() => console.log("Clicou no banner 1")}>
        <Image source={require("@/src/assets/banners/banner1.png")} className='w-full h-36 md:h-60 rounded-2xl'/>
    </Pressable>
    <Pressable className='w-full h-36 md:h-60 rounded-2xl' key="2" onPress={() => console.log("Clicou no banner 2")}>
        <Image source={require("@/src/assets/banners/banner2.png")} className='w-full h-36 md:h-60 rounded-2xl'/>
    </Pressable>
   </PagerView>
   </View>
  );
